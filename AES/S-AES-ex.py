...
def keyExpansion(key):
    ...
    def sub2Nib(B)/>/>:
        # swaps and then subsitutes the key using the above s-box
...
if __name__ == '__main__':
    ...
    if (choice == 1):
        print('\nPlease note that you must include 0b (to represent binary)'
              + ' before your inputs')
        plaintext = input(
            'Please enter your plaintext (ex: 0b1101011100101000): ')
        ...
        print('\nPlease note that you must include 0b (to represent binary)'
              + ' before your inputs')
        ciphertext = input(
            'Please enter your ciphertext (ex: 0b0010010011101100): ')
        key = input('Please enter your key (ex: 0b0100101011110101): ')
